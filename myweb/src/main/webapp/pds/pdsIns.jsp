...
<%
	try{
		//1) 첨부된 파일 저장하기
		String saveDirectory=application.getRealPath("/storage");	//실제 물리적인 경로
		int maxPostSize=1024*1024*50;								//저장 최대용량(10M)
		String encoding="UTF-8";									//한글 인코딩
		MultipartRequest mr=new MultipartRequest(request, saveDirectory, maxPostSize, encoding, new DefaultFileRenamePolicy());

		//2) 1에서 저장한 파일의 파일명, 파일크기 가져오기
		String fileName="";	//파일명
		...
		if(cnt==0){
			out.println("<p>포토갤러리 업로드에 실패했습니다</p>");
